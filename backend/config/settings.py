...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-colegio-grm-mvp-secret-key-2026')
...
# Database
# Default: SQLite for fast local development and testing, PostgreSQL if DATABASE_URL configured.
DATABASES = {
    'default': {
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'apps.guardians.authentication.GuardianDeviceAuthentication',
    ),
